      ...
      >
        ...
        >
          <h1 className="text-4xl md:text-5xl font-black tracking-tight">
            ...
            <span className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 dark:from-gray-200 dark:via-gray-100 dark:to-gray-200 bg-clip-text text-transparent">
              量化课堂
            </span>
          </h1>
        </motion.div>
